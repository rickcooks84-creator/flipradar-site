      ...
      <div style={{ width: "100%", maxWidth: 380, position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", marginBottom: 26 }}>
          ...
          <div style={{ color: MUTED, fontSize: 13, marginTop: 8, lineHeight: 1.5 }}>
            {expired
              ? "Your subscription looks inactive, so we signed you out. Renew on Whop and log back in."
              : "Log in with your license key. We’ll keep you signed in on this device."}
          </div>
        </div>
